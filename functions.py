...
# reference: http://www.pythonforbeginners.com/basics/string-manipulation-in-python


def total_meal_price(meal_price, tip=.15):
    return float(meal_price + meal_price * tip)
...
def sign_and_parity(num):
    ...
    if num > 0:
        num_description.append("Positive")

    else:
        num_description.append("Negative")

    if num % 2 == 0:
        num_description.append("Even")
      
    else:
        num_description.append("Odd")
